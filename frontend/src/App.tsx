...
import {
    ...
    CSSObject,
    Divider,
    IconButton, List, ListItem, ListItemButton, ListItemIcon, ListItemText, Menu, MenuItem,
    styled,
    Theme,
    Toolbar,
    Typography,
    ...
    return (
        ...
        <Box sx={{display: 'flex'}}>
            ...
            <Drawer variant="permanent" open={open}>
                ...
                <Divider/>
                <List>
                    <ListItem key=" メニュー1" disablePadding sx={{display: 'block'}}>
                        <ListItemButton sx={{minHeight: 48, justifyContent: open ? 'initial' : 'center'}}>
                            <ListItemIcon
                                sx={{minWidth: 0, mr: open ? 3 : 'auto', justifyContent: 'center'}}>
                                <InboxIcon/>
                            </ListItemIcon>
                            <ListItemText primary=" メニュー1" sx={{opacity: open ? 1 : 0}}/>
                        </ListItemButton>
                    </ListItem>
                </List>
            </Drawer>
