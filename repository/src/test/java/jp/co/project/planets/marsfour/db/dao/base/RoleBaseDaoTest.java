...
public class RoleBaseDaoTest {
    ...
    public void testSelectById(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/marsfour/db/dao/base/RoleBaseDao/selectById.sql", dialect);
        execute(sqlFile);
    }
