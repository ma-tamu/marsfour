...
public class UserRoleBaseDaoTest {
    ...
    public void testSelectById(TestInfo testInfo) throws Exception {
        SqlFile sqlFile = repository.getSqlFile(testInfo.getTestMethod().get(), "META-INF/jp/co/project/planets/marsfour/db/dao/base/UserRoleBaseDao/selectById.sql", dialect);
        execute(sqlFile);
    }
